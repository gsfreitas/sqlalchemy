...
set -gx VIRTUAL_ENV 'C:\Users\gfrei\Documents\3. PROJETOS\2. JORNADA_DE_DADOS\SQLALCHEMY\.venv'
...
if test -n sqlalchemy-py3.12
    set -gx VIRTUAL_ENV_PROMPT sqlalchemy-py3.12
else
